...
function HomePage() {
    ...
    const register = async (e, value) => {
        ...
        localStorage.setItem('fromHome', 'true'); // Set flag
        ...
        <div className="tags-area-home">
        {
            (cardTitles.length !== 0) ? (
                cardTitles.map((v, index_i) => (
                    <div className="tags-home">
                        {v.map((value, index_j) => (
                            ...
                            <div className="card-body card-body-css-home">
                                <h5 className="card-title card-title-heading-home">{value}</h5>
                                <p className="card-text card-p-text-home">{cardDescs[index_i][index_j]}</p>
                                <div className="tags2-home">
                ...
                <div className="no-project-home">
                    ...
                    <p>Check your <a className="link" href="/my-projects">My Projects</a> page instead</p>
                </div>
            )
        }
        </div>

    ...
    return (
        <div onClick={handleClick} className="popup-container">
            ...
            <div className="popup">
                        ...
                        <p className='p-ivstyle'>इस प्रयोग में आपको दिए गए शब्द का मूल्यांकन उसके "सकारात्मक /सुखद" या "नकारात्मक/ अप्रिय" भाव के हिसाब से 1 से 7 की मापनी (Scale) पर करना है।   </p>

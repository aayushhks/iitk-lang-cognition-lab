    ...
    return (
        <div onClick={handleClick} className="popup-container">
            ...
            <div className="popup">
                        ...
                        <p className='p-ivstyle'>इइसी प्रकार बाकि शब्द जो इन दोनों भावों के बीच मे आते है , उन शब्दों के लिए 2 ,3 ,4 ,5  या 6  अंक उनके शांत  से उत्तेजक  (क्रमानुसार) होने के हिसाब से दे सकते है। </p>
